...
{
      cout << "Petrol price: " << fixed << setprecision(2) << gasoline_price << " PLN" << endl; // fixed, then setprecision to specify the number of decimal places
      cout << "Average fuel consumption: " << average_consumption << " liters" << endl;
