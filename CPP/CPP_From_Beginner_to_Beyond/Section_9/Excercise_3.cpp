...
Note, it's possible -99  is not in the vector! If -99  is not in the vector then the result will be 
...
But please make sure you give it a go yourself first, and only check the solution if you really get 
stuck.
